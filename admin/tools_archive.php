    ...
    try {
        ...
        if (mysqli_stmt_execute($stmtInsert)) {
            ...
            if (mysqli_stmt_execute($stmtDelete)) {
                ...
                header("Location: tools.php?status=success");
                exit();
            } else {
                        ...
                        <tr class="bg-gray-50 border-b dark:bg-gray-800 dark:border-gray-700 font-bold">
                            ...
                            <td class="text-center px-1 py-1">
                                <div class="flex items-center space-x-2 justify-center">
                                    <a href="tools_view.php?id=<?php echo $row['id']; ?>" class="text-black ">
                                        <div class="flex items-center space-x-2 justify-center">
                                    ...
                                    <form method="POST" action="tools_archive.php" style="display:inline;">
