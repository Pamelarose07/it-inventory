...
$sql = "SELECT * FROM asset WHERE `asset_type` = 'Printer'";
...
$count_sql = "SELECT COUNT(*) AS record_count FROM asset WHERE `asset_type` = 'Printer'";
...
<body>
    ...
    <div class="flex-1 p-8">
        <div class="flex items-center justify-between"> <!-- Flex container for layout -->
            ...
            <h5 class="text-2xl uppercase font-medium">Printer</h5>
                        ...
                        <tr class="bg-gray-50 border-b dark:bg-gray-800 dark:border-gray-700 font-bold">
                            ...
                            <td class="text-center px-1 py-1">
                                <div class="flex items-center space-x-2 justify-center">
                                    <a title="view" href="printer_view.php?id=<?php echo $row['id']; ?>" class="text-black ">
                                    ...
                                    <form method="POST" action="printer_delete.php" style="display:inline;">
                                    ...
                                    <a title="archive" href="printer_archive.php?id=<?php echo $row['id']; ?>" class="text-black ">
