...
$sql = "SELECT * FROM asset WHERE `asset_type` = 'POS'";
...
$count_sql = "SELECT COUNT(*) AS record_count FROM asset WHERE `asset_type` = 'POS'";
                        ...
                        <tr class="bg-gray-50 border-b dark:bg-gray-800 dark:border-gray-700 font-bold">
                            ...
                            <td class="text-center px-1 py-1">
                                <div class="flex items-center space-x-2 justify-center">
                                    <a title="view" href="pos_view.php?id=<?php echo $row['id']; ?>" class="text-black ">
                                    ...
                                    <form method="POST" action="pos_delete.php" style="display:inline;">
                                    ...
                                    <a title="archive" href="pos_archive.php?id=<?php echo $row['id']; ?>" class="text-black ">
