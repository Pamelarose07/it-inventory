...
$count_sql = "SELECT COUNT(*) AS record_count FROM login";
...
<body>
    ...
    <div class="flex-1 p-8">
        <div class="flex items-center justify-between"> <!-- Flex container for layout -->
            ...
            <h5 class="text-2xl uppercase font-medium"> User</h5>
                ...
                <?php if (mysqli_num_rows($result) > 0) : ?>
                    <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                        <tr class="bg-gray-50 border-b dark:bg-gray-800 dark:border-gray-700 font-bold">
                            <td class="text-center px-1 py-1"><?php echo htmlspecialchars($row['id']); ?></td>
                            <td class="text-center px-1 py-1"><?php echo htmlspecialchars($row['username']); ?></td>

                            <td class="text-center px-1 py-1">
                                <div class="flex items-center space-x-2 justify-center">
                                    <a title="view" href="user_view.php?id=<?php echo $row['id']; ?>" class="text-black ">
